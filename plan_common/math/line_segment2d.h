...
#ifndef AD_BYD_PLANNING_MATH_LINE_SEGMENT2D_H
#define AD_BYD_PLANNING_MATH_LINE_SEGMENT2D_H
...
namespace planning {
namespace math {
using LineSegment2d = st::Segment2d;
/**
 * @class LineSegment2d
...
//   /** @brief Get a new line-segment with the same start point, but rotated
//    * counterclock-wise and expand to specific length by the given amount.
//    * @return The rotated line-segment's end-point.
//    */
...
//    *         with the input other_segment.
//    */
//   bool GetIntersect(const LineSegment2d &other_segment, Vec2d *const point)
//   const;
...
//    * @param foot_point The computed perpendicular foot from the input point
//    to
//    *        the straight line expanded from the line segment.
//    * @return The distance from the input point to the perpendicular foot.
//    */
//   double GetPerpendicularFoot(const Vec2d &point, Vec2d *const foot_point)
//   const;
...
#endif  // AD_BYD_PLANNING_MATH_LINE_SEGMENT2D_H