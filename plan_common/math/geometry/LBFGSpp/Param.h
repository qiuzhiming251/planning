...
class LBFGSParam {
 public:
  ...
  /// This parameter specifies the line search termination condition that will
  /// be used by the LBFGS routine. The default value is
...
class LBFGSBParam {
 public:
  ...
  /// where \f$f_k(x)\f$ is the current function value, and \f$f_{k-d}(x)\f$ is
  /// the function value \f$d\f$ iterations ago (specified by the \ref past
  /// parameter). The default value is \c 1e-10.
  ///
  Scalar delta;
  ///
  /// The maximum number of iterations.
