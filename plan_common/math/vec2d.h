...
#ifndef AD_BYD_PLANNING_MATH_VEC2D_H
#define AD_BYD_PLANNING_MATH_VEC2D_H
//#include <cmath>
//#include <string>
...
namespace planning {
namespace math {
using Vec2d = st::Vec2<double>;
constexpr double kMathEpsilon = st::kMathEpsilon;
...
//   //! Returns the distance to a line linking by two points
//   double DistanceToLine(const Vec2d &p0, const Vec2d &p1) const;
...
#endif  // AD_BYD_PLANNING_MATH_VEC2D_H