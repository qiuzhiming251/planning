#pragma once
#ifndef AD_BYD_PLANNING_MATH_BOX2D_H_
#define AD_BYD_PLANNING_MATH_BOX2D_H_
#include <limits>
#include <string>
#include <vector>
 ...
 * @brief ad_byd::planning::math
 */
namespace ad_byd {
namespace planning {
namespace math {
using Box2d = st::Box2d;
/**
 * @class Box2d
...
//   /**
//    * @brief Gets the closest corner at the given angle of the box
//    * @param angle The angle where want to get the corner
//    * @return A Vector of the corner
//    */
//   Vec2d GetSupportPoint(double angle) const;

//   double LazyDistanceTo(const Box2d &box) const;
...
#endif  // AD_BYD_PLANNING_MATH_BOX2D_H_