...
#ifndef AD_BYD_PLANNING_MATH_POLYGON2D_H
#define AD_BYD_PLANNING_MATH_POLYGON2D_H
#include <vector>
...
//   /**
//    * @brief Set Points when default construction
//    * @param points The points to construct the polygon.
//    */
...
//       std::vector<LineSegment2d> *const overlap_line_segments) const;
