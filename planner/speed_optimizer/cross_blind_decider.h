...
#ifndef ONBOARD_PLANNER_SPEED_CROSS_BLIND_DECIDER_H_
#define ONBOARD_PLANNER_SPEED_CROSS_BLIND_DECIDER_H_
...
#endif  // ONBOARD_PLANNER_SPEED_CROSS_BLIND_DECIDER_H_
